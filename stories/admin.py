...
class VariantsAdmin(ModelAdmin):
    list_display = ['id', 'product', 'title', 'color', 'size', 'image_tag', 'quantity', 'price', 'created_date', 'updated_date']
    list_editable = ['color', 'size', 'quantity', 'price']
    search_fields = ['title']
    list_filter = ['product', 'color', 'size', 'created_date', 'updated_date']
    readonly_fields = ['id', 'image_tag', 'created_date', 'updated_date']
...
class ProductAdmin(ModelAdmin):
    ...
    list_display = ['id', 'category', 'brand', 'title', 'model_title', 'available_in_stock_msg', 'in_stock_max', 'in_stock_min', 
